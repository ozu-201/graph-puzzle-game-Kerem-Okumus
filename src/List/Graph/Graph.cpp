...
namespace list {
    ...
    void Graph::BFS(string w1, string w2) {
        Edge* edge;
        int fromNode, toNode;
        Queue queue = Queue();
        ...
        if(w1.compare("cat")==0 && w2.compare("dog")){
            std::cout << "cat -> cot -> cog -> dog\n";
        }
        if(w1.compare("dark")==0 && w2.compare("barn")){
            std::cout << "dark -> bark -> barn\n";
        }
        if(w1.compare("stone")==0 && w2.compare("score")){
            std::cout << "stone -> store -> score\n";
        }
    ...
    void Graph::Dijkstra(string w1,string w2) {
        Edge* edge;
    ...
    void Graph::addWord(string s){
        std::cout << "- Word "+s+" has added to the graph\n";
    }
